...
function render(s){
  ...
  const oppoLog=(s.oppo_trigger_log||[]).filter(o=>['BOUGHT','SELL','SOLD'].includes(o.status));
  ...
  document.getElementById('root').innerHTML=`
    ...
    <div class="section">
      <h2>OPPO Trigger Log <span style="font-size:11px;color:#5a6a85;font-weight:400">(shows OPPO buy/sell events only)</span></h2>
