...
POLL_SECS = int(os.getenv("WORLD_CUP_POLL_SECS", "10"))
...
FIRST_HALF_CORNERS_MATCHES = int(os.getenv("WORLD_CUP_FIRST_HALF_CORNERS_MATCHES", "3"))
...
FIRST_HALF_CORNERS_OVER_ENTRIES_RAW = os.getenv("WORLD_CUP_FIRST_HALF_CORNERS_OVER_ENTRIES", "0.02:50,0.04:10,0.05:15").strip()
FIRST_HALF_CORNERS_UNDER_ENTRIES_BY_TOTAL_RAW = os.getenv("WORLD_CUP_FIRST_HALF_CORNERS_UNDER_ENTRIES_BY_TOTAL", "3.5=0.02:50,0.03:20,0.04:10|4.5=0.02:90,0.03:20,0.04:10,0.05:5").strip()
FIRST_HALF_CORNERS_OVER_ENTRIES_BY_TOTAL_RAW = os.getenv("WORLD_CUP_FIRST_HALF_CORNERS_OVER_ENTRIES_BY_TOTAL", "3.5=0.02:80,0.03:50,0.04:30,0.05:15|4.5=0.02:50,0.03:10,0.04:10,0.05:5").strip()
