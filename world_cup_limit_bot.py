...
POLL_SECS = int(os.getenv("WORLD_CUP_POLL_SECS", "5"))
...
SELL_ORDER_EXPIRATION_MINUTES = int(os.getenv("WORLD_CUP_SELL_ORDER_EXPIRATION_MINUTES", "1"))
